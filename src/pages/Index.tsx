...
const projects = [
  { title: "E-Commerce Platform", category: "Web Development", color: "from-accent/20 to-accent/5" },
  { title: "Health & Fitness App", category: "Mobile App", color: "from-blue-500/20 to-blue-500/5" },
